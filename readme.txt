=== AnchorMate ===
Contributors:      Highfivery, bmarshall511
Tags:              Anchor Link, Anchors
Stable tag:        1.0.0
...
Development takes place in the [GitHub repository](https://github.com/Highfivery/anchormate).

== Technical Notes ==

* Requires PHP 7.4+.
* Requires [WordPress](http://wordpress.org/) 5.7+
* Issues and Pull requests welcome in the [GitHub repository](https://github.com/Highfivery/anchormate).
